                            ...
                            <div class="auth-form">
                                <div class="text-center mb-3">
                                    <a href="{{route('admin.home')}}" class="brand-logo">
                                        ...
                                        <img src="{{asset('backend/images/project-logo/logo.png')}}" alt="">
                                    </a>
                                </div>
                                ...
                                <form method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter email" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus>
