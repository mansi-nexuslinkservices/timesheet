	...
	<div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					...
					<div>
						<a href="{{route('admin.designation.create')}}" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New Designation</a>
					</div>
				</div>
				<div class="row">
					<div class="col-xl-12">
	...
	<script>
		$(document).ready(function(){
			...
			var table = $('#example5').dataTable({
	            ...
	            autoWidth: false,
	            ajax: "{{ route('admin.getDesignation') }}",
	            columns: [
	                ...
	                {"render": function (data, type, row, meta ) {
	                    ...
	                    var view_url  = "{{route('admin.designation.show',':id')}}";
	                    var edit_url  = "{{route('admin.designation.edit',':id')}}";
	                    var delete_url  = "{{route('admin.designation.destroy',':id')}}";
