	...
	<div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					...
					<div>
						<a href="{{route('admin.languages.create')}}" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New Language</a>
					</div>
				</div>
				<div class="row">
					<div class="col-xl-12">
	...
	<script>
			...
			var table = $('#example5').dataTable({
	            ...
	            columns: [
	                ...
	                {"render": function (data, type, row, meta ) {
	                    ...
	                    var view_url  = "{{route('admin.languages.show',':id')}}";
	                    var edit_url  = "{{route('admin.languages.edit',':id')}}";
	                    var delete_url  = "{{route('admin.languages.destroy',':id')}}";
	    ...
	    function deleteRow(id) {
	       swal({
		        ...
		        function (isConfirm)  {
		        	if (isConfirm.value){
			            var url = '{{ route("admin.languages.destroy", ":id") }}';
