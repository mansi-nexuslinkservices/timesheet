	...
	<div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					...
					<div>
						<a href="{{route('admin.project-type.create')}}" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New ProjectType</a>
					</div>
				</div>
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table class="table display mb-4 dataTablesCard project-table table-responsive-xl card-table" id="example5">
								<thead>
									<tr>
										<th>No</th>
										<th>ProjectType</th>
	...
	<script>
		$(document).ready(function(){
			...
			var table = $('#example5').dataTable({
	            ...
	            autoWidth: false,
	            ajax: "{{ route('admin.getProjectType') }}",
	            columns: [
	                ...
	                {"render": function (data, type, row, meta ) {
	                    ...
	                    var view_url  = "{{route('admin.project-type.show',':id')}}";
	                    var edit_url  = "{{route('admin.project-type.edit',':id')}}";
	                    var delete_url  = "{{route('admin.project-type.destroy',':id')}}";
	    ...
	    function deleteRow(id) {
	       swal({
		        ...
		        function (isConfirm)  {
		        	if (isConfirm.value){
			            var url = '{{ route("admin.project-type.destroy", ":id") }}';
