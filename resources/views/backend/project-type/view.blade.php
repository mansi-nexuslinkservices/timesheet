								...
								<div class="col-xl-12">
									<div class="ms-8">
										...
										<p class="font-w600 mb-3">
											...
											<span class="font-w400">
												{{date("m/d/Y H:i A", strtotime($projectType->created_at)) ?? ''}}
											</span>
										</p>

										<p class="font-w600 mb-3">
											<span class="custom-label">Status:</span>
											<span class="font-w400 @if($projectType['status'] == 1) {{'badge badge-success'}} @else {{'badge badge-danger'}}@endif">
												@if($projectType['status'] == 1) {{'Active'}} @else {{'InActive'}}@endif
											</span>
										</p>
									</div>
								</div>
