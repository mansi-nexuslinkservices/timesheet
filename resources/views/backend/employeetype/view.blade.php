								...
								<div class="col-xl-12">
									<div class="ms-8">
										<p class="font-w600 mb-3">
											<span class="custom-label">UserType :</span>
										...
										<p class="font-w600 mb-3">
											...
											<span class="font-w400">
												{{date("m/d/Y H:i A", strtotime($usertype->created_at)) ?? ''}}
											</span>
										</p>

										<p class="font-w600 mb-3">
											<span class="custom-label">Status:</span>
											<span class="font-w400 @if($usertype['status'] == 1) {{'badge badge-success'}} @else {{'badge badge-danger'}}@endif">
												@if($usertype['status'] == 1) {{'Active'}} @else {{'InActive'}}@endif
											</span>
										</p>
									</div>
								</div>
