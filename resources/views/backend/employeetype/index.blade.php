	...
	<div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					...
					<div>
						<a href="{{route('admin.employee-types.create')}}" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New Employee Type</a>
					</div>
				</div>
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table class="table display mb-4 dataTablesCard usertype-table table-responsive-xl card-table" id="example5">
								<thead>
									<tr>
										<th>No</th>
										<th>Employee Type</th>
	...
	<script>
		$(document).ready(function(){
			...
			var table = $('#example5').dataTable({
	            ...
	            autoWidth: false,
	            ajax: "{{ route('admin.getEmployeeType') }}",
	            columns: [
	    ...
	    function deleteRow(id) {
	       swal({
		        ...
		        function (isConfirm)  {
		        	if (isConfirm.value){
			            var url = '{{ route("admin.employee-types.destroy", ":id") }}';
