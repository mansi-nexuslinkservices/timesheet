	...
	<div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					...
					<div>
						<a href="{{route('admin.employees.create')}}" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add Employee</a>
					</div>
				</div>
				<div class="row">
					<div class="col-xl-12">
			...
			var table = $('#example5').dataTable({
	            ...
	            columns: [
	                ...
	                {"render": function (data, type, row, meta ) {
	                    ...
	                    var view_url  = "{{route('admin.employees.show',':id')}}";
	                    var edit_url  = "{{route('admin.employees.edit',':id')}}";
	                    var delete_url  = "{{route('admin.employees.destroy',':id')}}";
